...
function normalizeProviderFeature(feature: SafetyFeature): SafetyFeature {
  ...
  const baseProviderProperties = compactRecord({
    ...
    waterTemperatureC: feature.properties.waterTemperatureC,
    floodStage: feature.properties.floodStage,
    trend: feature.properties.trend,
    detailUrl: feature.properties.detailUrl,
    timelineUrl: feature.properties.timelineUrl,
    forecastAvailable: feature.properties.forecastAvailable,
    forecastUntil: feature.properties.forecastUntil,

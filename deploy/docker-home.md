...
SITUATION_DATA_ENABLED_SOURCES=open_meteo,aviation_weather,chmi_weather_stations,chmi_air_quality,osm_postgis,community_context,mobile_coverage_model,mobile_network_model,ctu_nettest,ctu_stationary_mobile,pid_gtfs_rt,road_srti_lod,tpeg2,safety_data
...
VALHALLA_TRAFFIC_CONTROL_TOKEN=<independent-server-only-secret>

...
FLIGHT_DATA_CACHE_TTL_SECONDS=15
EOF
...
- Flight Data API je defaultně v bezpečném syntetickém režimu `FLIGHT_DATA_ENABLED_SOURCES=mock`.
- Pro live ADSB.lol pilot nastav `FLIGHT_DATA_ENABLED_SOURCES=adsb_lol`; u komerčního použití musí být vyřešená ODbL atribuce a share-alike povinnosti.

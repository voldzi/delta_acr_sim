...
```bash
SITUATION_DATA_ENABLED_SOURCES=open_meteo,aviation_weather,ctu_nettest,ctu_stationary_mobile,pid_gtfs_rt,public_transit_static,safety_data,ardos_partner

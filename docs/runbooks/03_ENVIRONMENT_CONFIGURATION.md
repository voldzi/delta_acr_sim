...
- `SIM_OPERATIONS_PROVIDER_MAX_RESPONSE_BYTES`
...
- `SITUATION_DATA_PID_GTFS_RT_CACHE_TTL_SECONDS`
...
- `TPEG2_MAX_RECORDS`
- `VALHALLA_TRAFFIC_ENABLED`
- `VALHALLA_TRAFFIC_CONTROL_TOKEN` (samostatný tajný server-to-server bearer)
- `VALHALLA_TRAFFIC_IDLE_SECONDS` (výchozí 900 s)
...
- `SITUATION_DATA_ROUTING_CACHE_TTL_SECONDS`
- `SITUATION_DATA_ROUTING_CACHE_MAX_ENTRIES`
- `ROUTING_ENGINE`
- `VALHALLA_BASE_URL`
- `GEO_ROUTING_SERVICE_TOKENS`
- `GEO_ROUTING_AUDIENCE`
- `GEO_ROUTING_MAX_WAYPOINTS`
- `GEO_ROUTING_MAX_TOTAL_DISTANCE_M`
- `GEO_ROUTING_RATE_LIMIT_PER_MINUTE`
- `GEO_ROUTING_PRECOMPUTE_DIR`
- `VALHALLA_IMAGE`
- `VALHALLA_TILE_URLS`
...
- `VALHALLA_PORT`
- `SITUATION_DATA_ROUTING_MAX_GRAPH_EDGES`
...
SIM_OPERATIONS_PROVIDER_MAX_RESPONSE_BYTES=1048576
...
TPEG2_API_TOKEN=<server-side-secret>
...
VALHALLA_TRAFFIC_CONTROL_TOKEN=<independent-high-entropy-token>
...
GEO_ROUTING_SERVICE_TOKENS=<consumer-a>:<high-entropy-token>,<consumer-b>:<different-high-entropy-token>
...
SITUATION_DATA_ROUTING_MAX_SNAP_DISTANCE_M=2500
